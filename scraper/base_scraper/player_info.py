...
#   This script scrapes the Dodgers player information from the MLB website and updates a local SQLite database.
def player_info(  db_path='/Users/daniellarson/Desktop/Code/Projects/dodgers_injtrkr/data/dodgers_injury_db.sqlite'):
